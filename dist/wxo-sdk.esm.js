...
class WxOClient {
  ...
  fetchChatStarterSettings(agentId) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var params = agent.agentEnvironmentId ? "?environment_id=".concat(encodeURIComponent(agent.agentEnvironmentId)) : '';
      var path = "/v1/orchestrate/agents/".concat(encodeURIComponent(agent.agentId), "/chat-starter-settings").concat(params);
      try {
